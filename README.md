...
![Python](https://img.shields.io/badge/Python-3.9+-blue) ![pandas](https://img.shields.io/badge/pandas-data--analysis-150458) ![scikit-learn](https://img.shields.io/badge/scikit--learn-ML-f7931e) ![SQLite](https://img.shields.io/badge/SQLite-SQL-003b57) ![seaborn](https://img.shields.io/badge/seaborn-visualization-4c72b0) ![License: MIT](https://img.shields.io/badge/License-MIT-green)

**Tech stack & skills:** SQL (SQLite) · Python · pandas · NumPy · Matplotlib · seaborn · scikit-learn · mlxtend (Apriori) · folium — covering SQL querying & joins, data cleaning, exploratory data analysis, association-rule mining, KMeans clustering, outlier detection, and classification modelling.
...
1. **Data assembly (SQL)** — connects to the SQLite database and uses SQL queries (`SELECT`, `WHERE`, and table `JOIN`s across `accident`, `vehicle`, `casualty`, and `lsoa`) via `pandas.read_sql_query` to build DataFrames for accident year 2020.
...
If you use this project, please cite it. Citation metadata is provided in [`CITATION.cff`](CITATION.cff), and GitHub will show a **“Cite this repository”** button on the repo page.

> Irshad, A. (2026). *Road Accident Data Mining* [Computer software]. https://github.com/Asadullah-Irshad/Road-Accident-Data-Mining
